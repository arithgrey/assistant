class Adicionals:
    ...
    def products():
        return {
            "materiales":{
                "Material de los discos: polipropileno ideales para no romper el piso",
                "Material de las barras y mancuernas: metal, semisolidas",
                
            },
            "KIT DE PESAS 16 DISCOS 34KG EN TOTAL, BARRA Z, BARRA RECTA Y MANCUERNAS | ENVÍO GRATIS":{
                """ Peso total de los discos 34.00 Kg
            ...
            "KIT DE PESAS 16 DISCOS 42KG EN TOTAL, BARRA Z, BARRA RECTA Y MANCUERNAS | ENVÍO GRATIS":{
                """
                Peso total de los discos 42.00 Kg
            ...
            "KIT DE PESAS 20 DISCOS 50KG EN TOTAL, BARRA Z, BARRA RECTA Y MANCUERNAS | ENVÍO GRATIS":{
                """
                Peso total de los discos 50.00 Kg
            ...
            "PARA QUIEN QUIERE TODO, SIN ESPACIO":{
                """
                KIT 16 DISCOS 42KG EN TOTAL MANCUERNAS, BARRA RECTA, BARRA Z BARRA ROMANA | ENVÍO GRATIS
            ...
            "PARA LOS QUE YA NO VAN AL GYM":{
                """
                KIT 80KG MANCUERNAS, BARRA ROMANA, BARRA Z, BARRA RECTA | ENVÍO GRATIS

                Peso total de los discos 80.00 Kg
            ...
            "PARA LOS QUE HACEN CALISTENIA":{
                """
                BARRAS 8 EN 1 SUPER REFORZADAS ENVÍO GRATIS
            ...
            "PARA LOS QUE SOLO OCUPAN MANCUERNAS":{
                """
                PAR DE MANCUERNAS DE 10KG EN TOTAL 20 KG SON 2 PIEZAS | ENVÍO GRATIS

                Peso total de los discos 20.00 Kg
            ...
            "PARA LOS QUE SOLO OCUPAN MANCUERNAS":{
                """
                PAR DE MANCUERNAS DE 6KG EN TOTAL 12 KG SON 2 PIEZAS | ENVÍO GRATIS

                Peso total de los discos 12.00 Kg
            ...
            "PARA LOS QUE SOLO OCUPAN MANCUERNAS":{
                """
                PAR DE MANCUERNAS DE 8KG EN TOTAL 16 KG SON 2 PIEZAS | ENVÍO GRATIS

                Peso total de los discos 16.00 Kg
            ...
            "PARA LOS QUE SOLO OCUPAN MANCUERNAS":{
                """
                PAR DE MANCUERNAS DE 4KG EN TOTAL 8 KG SON 2 PIEZAS | ENVÍO GRATIS

                Peso total de los discos 8.00 Kg
            ...
            "PARA LOS QUE OCUPAN MANCUERNAS y BARRA":{
                """
                BARRA 22KG + PAR MANCUERNAS 10KG EN TOTAL 42KG A DOMICILIO PAGAS A TU ENTREGA 16 DISCOS | ENVÍO GRATIS
            ...
            "PARA LOS QUE SOLO OCUPAN BARRA":{
                """
                BARRA RECTA DE 22KG 8 DISCOS AJUSTABLES, PESOS VARIABLES | ENVÍO GRATIS

                Peso total de los discos 22.00 Kg
            ...
            "PARA LOS QUE QUIEREN HACER EL PREDICADOR EN CASA SIN EXCEDERSE":{
                """
                BARRA Z CON 2 SEGUROS PARA DISCOS STANDARD DE UNA PULGADA, SOPORTA 60KG | ENVÍO GRATIS
